...
Article* readCSV(const string& inputFile, int& count, bool trackIssues = false) {
    ...
    // DEBUG - Print the first node of the linked list
    if (head) {
        cout << "\n\n[DEBUG] First article in linked list:" << endl;
        cout << "Article: " << head->title << " | " << head->content << " | " << head->subject << " | " << head->date << endl;
    }

    //DEBUG  - Print the last node of the linked list
    if (tail) {
        cout << "\n\n[DEBUG] Last article in linked list:" << endl;
        cout << "Article: " << tail->title << " | " << tail->content << " | " << tail->subject << " | " << tail->date << endl;
    }
